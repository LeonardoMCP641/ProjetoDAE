    ...
    <aside class="w-64 bg-white border-r border-gray-200 flex flex-col fixed h-full z-50">
      ...
      <nav class="flex-1 overflow-y-auto py-6 px-4 space-y-1">
        ...
        <div v-if="user?.role === 'Administrador' || user?.role === 'Responsavel'" class="mt-8">
          ...
          <NuxtLink v-if="user?.role === 'Administrador'" to="/users" class="flex items-center px-4 py-2.5 text-gray-600 rounded-xl hover:bg-orange-50 hover:text-orange-600 transition group">
      ...
      <div v-if="user" class="p-4 border-t border-gray-100 bg-gray-50/50">
        ...
        <div class="grid grid-cols-2 gap-2">
          <NuxtLink to="/users/profile" class="flex items-center justify-center px-3 py-1.5 text-xs font-bold text-gray-600 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 transition text-center">
            Perfil
          </NuxtLink>
    ...
    <div class="flex-1 flex flex-col ml-64 min-w-0 transition-all duration-300">
        ...
        <div v-if="token" class="flex items-center space-x-4">
          <div class="relative">
            <button
                ...
                class="p-2 rounded-full text-gray-400 hover:text-blue-600 hover:bg-blue-50 transition focus:outline-none relative"
            >
            ...
            <div v-if="isNotifMenuOpen" @click.away="isNotifMenuOpen = false" class="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-2xl border border-gray-100 py-2 z-50 origin-top-right animate-fadeIn">
              ...
              <div class="max-h-64 overflow-y-auto custom-scrollbar">
                <NuxtLink
                    ...
                    class="block px-4 py-3 hover:bg-blue-50/50 transition border-b border-gray-50 last:border-0 group"
                ...
                >
                  ...
                  <p class="text-[10px] text-gray-400 mt-1 flex items-center">
                    <i class="bi bi-clock mr-1"></i> {{ n.timestamp }}
                  </p>
                </NuxtLink>
      ...
      <footer class="bg-white border-t border-gray-200 py-6 mt-auto">
        <div class="max-w-7xl mx-auto px-8 text-center">
          <p class="text-sm text-gray-500">&copy; 2025 Centro de I&D XYZ - Plataforma DAE</p>
