    ...
    <div v-if="publication">
      ...
      <div class="card shadow-lg border-0">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center py-3">
          ...
          <span class="badge bg-light text-primary">{{ publication.tipo }}</span>
        </div>
        ...
        <div class="card-body p-4">
          <div class="row">
            <div class="col-md-8">
              ...
              <div class="mb-3">
                ...
                <div class="d-flex flex-wrap gap-2 mt-2">
                  <span v-if="publication.tags && publication.tags.length > 0"
                        v-for="tag in publication.tags" :key="tag.id"
            ...
            <div class="col-md-4 border-start ps-md-4">
              ...
              <div class="mb-4">
                 <span class="badge w-100 py-2" :class="publication.visivel ? 'bg-success' : 'bg-danger'">
                    {{ publication.visivel ? 'Publicação Visível' : 'Oculta / Rascunho' }}
                 </span>
              </div>
        ...
        <div class="card-footer bg-light text-muted small py-3">
          ...
          | Por: <strong>{{ publication.username || 'Sistema' }}</strong>
        </div>
      </div>
...
onMounted(async () => {
  ...
  try {
    ...
    // Ajustar se necessário (ex: user.value.role === 'Administrador')
